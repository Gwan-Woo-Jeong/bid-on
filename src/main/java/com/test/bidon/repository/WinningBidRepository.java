...
public interface WinningBidRepository extends JpaRepository<WinningBid, Long> {
    ...
    int countByWinBidIdAndLiveItemId(@Param("winningBidId") Long winningBidId, @Param("liveAuctionItemId") Long liveAuctionItemId, Long userId);
    ...
    int countByWinBidIdAndNormalItemId(@Param("winningBidId") Long winningBidId, @Param("auctionItemId") Long auctionItemId, Long userId);
